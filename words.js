...
let letterFill = ["a", "b", "c", "d", "e", "f", "g", "h", "i", "j",
...
let threeLetterWords=sortWords3()


//create array of 4 letter words
function sortWords4(){
    let fourLetterWords = []
    for(i=0; i<words.length; i++)
    if(words[i].length ===4){
...
let fourLetterWords=sortWords4()
...
let fiveLetterWords=sortWords5()


//create array of 6 letter words
function sortWords6(){
    let sixLetterWords = []
    for(i=0; i<words.length; i++)
    if(words[i].length ===6){
